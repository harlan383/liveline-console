...
const approvedTransitHaproxyRealCreateStage = "Stage 3.3.139-new-transit-haproxy-route-create-real-execution"
...
const approvedTransitHaproxyRouteName = "haproxy-tcp-23843"
