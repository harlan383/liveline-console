...
MIN_LANDING_NODE_CREATE_VERSION = "0.1.6-stage-3.3.37"
...
MIN_TRANSIT_ROUTE_HAPROXY_TCP_VERSION = "0.1.30-stage-3.3.175-hotfix-1-haproxy-install-runner"
MIN_TRANSIT_ROUTE_HAPROXY_TCP_VERSION_KEY = (0, 1, 30, 3, 3, 175)
