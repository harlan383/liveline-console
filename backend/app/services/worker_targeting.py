...
MIN_LANDING_NODE_CREATE_VERSION = "0.1.33-stage-3.3.180-dynamic-landing-create-port"
MIN_LANDING_NODE_CREATE_VERSION_KEY = (0, 1, 33, 3, 3, 180)
...
MIN_TRANSIT_ROUTE_HAPROXY_TCP_VERSION = "0.1.31-stage-3.3.175-hotfix-2-haproxy-systemd-run"
MIN_TRANSIT_ROUTE_HAPROXY_TCP_VERSION_KEY = (0, 1, 31, 3, 3, 175)
