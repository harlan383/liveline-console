...
| Stage 3.3.181 Xray v25.5.16 default and multi-inbound preserve | Record the production Reality invalid-connection fix, pin LiveLine-managed Xray-core to v25.5.16, upgrade older managed binaries safely, and preserve existing inbounds when adding dynamic landing ports; no real node, listener, remote upgrade, cutover, firewall, or share-link mutation |
